...
const DEFAULT_TOOL_RENAMES = [
  // === Real Hermes mcp__ tools (captured live 2026-06-26) — DOUBLE underscore ===
  ['mcp__browser_back', 'BrowserBack'],
  ['mcp__browser_click', 'BrowserClick'],
  ['mcp__browser_console', 'BrowserConsole'],
  ['mcp__browser_get_images', 'BrowserImages'],
  ['mcp__browser_navigate', 'BrowserNavigate'],
  ['mcp__browser_press', 'BrowserPress'],
  ['mcp__browser_scroll', 'BrowserScroll'],
  ['mcp__browser_snapshot', 'BrowserSnapshot'],
  ['mcp__browser_type', 'BrowserType'],
  ['mcp__browser_vision', 'BrowserVision'],
  ['mcp__clarify', 'AskUser'],
  ['mcp__computer_use', 'ComputerUse'],
  ['mcp__cronjob', 'Scheduler'],
  ['mcp__delegate_task', 'Task'],
  ['mcp__execute_code', 'CodeExec'],
  ['mcp__memory', 'MemoryStore'],
  ['mcp__patch', 'Edit'],
  ...
  ['mcp__skills_list', 'SkillList'],
  ['mcp__terminal', 'Bash'],
  ['mcp__text_to_speech', 'Speech'],
  ['mcp__todo', 'TodoWrite'],
  ['mcp__vision_analyze', 'VisionAnalyze'],
  ['mcp__write_file', 'Write'],
  ['exec', 'Bash'],
  ['process', 'BashSession'],
...
// ─── Response Processing ────────────────────────────────────────────────────
// Strip HTTP framing/encoding headers from an upstream header set before we
// re-send a rewritten body with our own content-length. If we leave
// transfer-encoding (chunked) OR content-encoding (gzip) in place while also
// setting content-length, the client sees conflicting framing (RFC 7230 3.3.2)
// and truncates the body -> "unexpected end of data". This was the root cause
// of intermittent HTTP 400 invalid-JSON truncation errors (2026-06-27).
